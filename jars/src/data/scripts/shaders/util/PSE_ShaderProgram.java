...
public class PSE_ShaderProgram {
    int programID;

    int vertexShaderID;
    int fragmentShaderID;

    public PSE_ShaderProgram() {
        programID = glCreateProgram();
    }

    public PSE_ShaderProgram createVertexShader(String shaderCode) {
    ...
    public PSE_ShaderProgram createFragmentShader(String shaderCode) {
        // Create the shader and set the source
